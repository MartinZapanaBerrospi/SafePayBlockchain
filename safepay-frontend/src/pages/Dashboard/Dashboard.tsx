...
export default function Dashboard() {
  ...
  return (
    <div className="dashboard-outer fade-in" style={{ paddingTop: 126, margin: '5vh auto 5vh auto', minHeight: 'calc(100vh - 126px)', background: 'var(--color-bg)', display: 'flex', justifyContent: 'center', alignItems: 'flex-start' }}>
      <div className="dashboard-panel" style={{ maxWidth: 1100, width: '100%', background: 'var(--color-card)', borderRadius: 18, boxShadow: '0 2px 16px #2563eb18', border: '1.5px solid var(--color-border)', padding: '2.5em 2em 2em 2em', margin: '0 auto' }}>
        <h2 style={{ textAlign: 'center', marginBottom: 24 }}>Dashboard de SafePay</h2>
        {loading ? (
